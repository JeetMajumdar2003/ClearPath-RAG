...
ClearPath RAG project a harassment-free experience for everyone, regardless of
...
- Respecting the privacy of patients, clinicians, and other stakeholders —
  ClearPath deals with clinical decision support; **never post real PHI or
  credentials in any channel**
...
tracker, discussions, pull requests, and any other official communication
channels — and also applies when an individual is officially representing the
project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainers at the contact published in
[`SUPPORT.md`](SUPPORT.md). All complaints will be reviewed and investigated
promptly and fairly.
...
determining the consequences of any action they deem in violation of this Code
of Conduct:
